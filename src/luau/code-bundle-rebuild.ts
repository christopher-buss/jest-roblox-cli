 ...
 * `BinaryInput` carries.
 *
 * Where it goes in a task script is `composeTaskScript`'s to say — it is one of
 * two preambles that have to be ordered against each other, and one function
 * owning both is what keeps a refused task from paying for a rebuild.
 *
