...
```toml
[plugins.jest_roblox]
github = "https://github.com/christopher-buss/jest-roblox-cli/releases/download/v0.4.3/JestRobloxRunner.rbxm"
```
...
Install the JestRobloxRunner.rbxm shipped with jest-roblox 0.4.3, and remove the other copies from your Studio plugins folder.
```
